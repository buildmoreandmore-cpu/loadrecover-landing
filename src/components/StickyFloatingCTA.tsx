    ...
    <>
      ...
      <div className="fixed bottom-8 left-8 z-50 hidden lg:block">
        <a
          ...
          className="bg-blue-600 hover:bg-blue-700 text-white px-4 py-3 rounded-full font-semibold shadow-2xl transition-all duration-300 hover:scale-105 flex items-center space-x-2 text-sm"
        >
